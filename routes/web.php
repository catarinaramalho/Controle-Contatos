...
Route::get('/contatos/{contatoId}/enderecos', 'App\Http\Controllers\EnderecosController@index')->name('listar_enderecos');
Route::get('/contatos/{contatoId}/dados', 'App\Http\Controllers\DadosController@index');
Route::get('/contato/{id}/adicionarEndereco', 'App\Http\Controllers\EnderecosController@adicionar');
Route::post('/contato/{id}/adicionarEndereco', 'App\Http\Controllers\EnderecosController@salvar');

Route::post('/contatos/{contatoId}/dados', 'App\Http\Controllers\ContatosController@editar');
Route::get('/enderecos/{id}', 'App\Http\Controllers\EnderecosController@verEndereco');
